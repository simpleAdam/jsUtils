...
it('returns a number',() => {
  expect(typeof normaliseInterpolate(5,4,6,0,1)).toBe("number")
})

it('interpolates correctly',() => {
  expect(normaliseInterpolate(5,4,6,0,1)).toBe(0.5)
  expect(normaliseInterpolate(5,4,6,1,3)).toBe(2)
  expect(normaliseInterpolate(5,4,6,-4,-6)).toBe(-5)
})
